...
import { IconButton, Paper, InputBase, Avatar, TextField, Dialog, DialogContent, DialogContentText, DialogTitle } from "@material-ui/core";
                            ...
                            <div className="d-flex flex-column">
                                <div className="d-flex flex-row">
                                    ...
                                    <Autocomplete
                                        ...
                                        value={country}
                                        options={countries}
                                        onChange={(e, value) => (value ? setCountry(value) : setCountry(null))}
                                        classes={{
                                        ...
                                        renderInput={(params) => (
                                            <TextField
                                                ...
                                                required
                                                error={countryError}
                                                helperText={countryError ? "Country cannot be emty" : " "}
                                            />
                                        )}
                                    />
                                </div>
